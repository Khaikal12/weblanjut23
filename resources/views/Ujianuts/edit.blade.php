...
@section('content')
    <div class="container px-4 mt-4">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" style="font-size: 20px; text-align: center"><strong>Edit Data Ujian</strong>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('ujianuts-update', $data->id) }}" method="POST">
                            @csrf
                            @method('patch')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="keterangan" id="" cols="30" rows="10" class="form-control" value="{{ $data->keterangan }}"></textarea>
                            </div>
                            <div class="mb-3">
